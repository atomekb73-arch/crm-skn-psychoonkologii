      ...
      <div className="bg-white rounded-2xl p-6 max-w-lg w-full shadow-2xl border border-slate-100 space-y-4 animate-in fade-in zoom-in-95 duration-150">
        ...
        <form onSubmit={handleSubmit} className="space-y-3.5">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div>
              <label htmlFor="edit-member-alias" className="block text-xs font-semibold text-slate-700 mb-1 flex items-center justify-between">
                <span>Aliasy / Dodatkowe nazwy z Google Meet (Kolumna J)</span>
              </label>
              <div className="relative">
                <Sparkles size={15} className="absolute left-3 top-1/2 -translate-y-1/2 text-purple-500" />
                <input
                  ...
                  className="w-full pl-9 pr-3 py-2 rounded-xl border border-slate-200 text-xs focus:ring-2 focus:ring-indigo-300 outline-none"
                  placeholder="Wprowadź inne imiona lub pseudonimy rozdzielone przecinkiem, np. Jarek Paszkiewicz, Jarosław"
                />
              </div>
              <p className="text-[10px] text-slate-400 mt-1">Używane do automatycznego łączenia obecności z logów Google Meet.</p>
            </div>
          </div>
