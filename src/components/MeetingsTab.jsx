...
import MeetingProtocolModal from './MeetingProtocolModal';
  ...
  return (
    <div className="space-y-6">
          ...
          {!selectedMeeting ? (
            ...
            <div className="bg-white rounded-2xl border border-slate-200 p-5 space-y-4 shadow-sm">
              ...
              <div className="flex items-center gap-2 my-2.5">
                ...
                >
                  <FileText className="w-5 h-5 shrink-0" size={20} />
      ...
      <MeetingProtocolModal
        ...
        onSaveToDocsRepo={handleSaveProtocolToDocsRepo}
        onPrint={handlePrintProtocol}
        saveStatus={protocolSaveStatus}
